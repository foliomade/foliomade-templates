import { e as createComponent, f as createAstro, m as maybeRenderHead, h as addAttribute, r as renderTemplate, l as renderComponent, k as renderHead, n as renderSlot, o as Fragment } from '../chunks/astro/server_BfIubAXm.mjs';
import 'kleur/colors';
import 'clsx';
/* empty css                                 */
...
const $$About = createComponent(($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$About;
  const { siteConfig } = Astro2.props;
  return renderTemplate`${renderComponent($$result, "Section", $$Section, { "text": "About Me", "href": "about" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="flex flex-col gap-6 md:gap-8"> <p class="w-auto text-base text-neutral md:pr-5" style="white-space: pre-line;">${siteConfig.aboutMe}</p> </div> ` })}`;
