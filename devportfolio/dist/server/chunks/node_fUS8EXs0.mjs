...
const baseService = {
  ...
  getURL(options, imageConfig) {
    ...
    const imageEndpoint = joinPaths("/t/devportfolio/", imageConfig.endpoint.route);
...
const imageConfig = {"endpoint":{"route":"/_image","entrypoint":"astro/assets/endpoint/node"},"service":{"entrypoint":"astro/assets/services/sharp","config":{}},"domains":[],"remotePatterns":[],"responsiveStyles":false};
							...
							const outDir = /* #__PURE__ */ new URL("file:///Users/samsonoyetola/workspace/NextJs/foliomade-monorepo/foliomade/templates/devportfolio/dist/client/");
